		...
		<div class="row">
			...
			<div class="col-md-6">
				<form method="post" action="simpan">
					...
					<div class="form-group"> 
						<label> minggu1</label>
						<input type="text" name="siswa_minggu1"
						class="form-control" placeholder="..."> 
					</div>

					<div class="form-group"> 
						<label>minggu2 </label>
						<input type="text" name="siswa_minggu2"
						class="form-control" placeholder="..."> 
					</div>

					<div class="form-group"> 
						<label>minggu3 </label>
						<input type="text" name="siswa_minggu3"
						class="form-control" placeholder="..."> 
					</div>

					<div class="form-group"> 
						<label>minggu4 </label>
						<input type="text" name="siswa_minggu4"
						class="form-control" placeholder="..."> 
					</div>

					<div class="form-group">
						<label>Tanggal </label>
						<input type="date" name="siswa_tanggal"
						class="form-control" placeholder="...">
					</div>
